...
class Chapter1_26: UIViewController, AVAudioPlayerDelegate, UICollectionViewDataSource, UICollectionViewDelegate {
    
    
    
    @IBAction func nextPage(_ sender: Any) {
        if currentColor == "brown" {
            let vc = self.storyboard?.instantiateViewController(withIdentifier: "chapter1_27")
