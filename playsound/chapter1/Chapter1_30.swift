...
class Chapter1_30: UIViewController, AVAudioPlayerDelegate, UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    func nextPage() {
        let vc = self.storyboard?.instantiateViewController(withIdentifier: "chapter1_31")
