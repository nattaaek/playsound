...
class Chapter1_21: UIViewController, AVAudioPlayerDelegate,UICollectionViewDelegate, UICollectionViewDataSource {
    
    
    @IBAction func nextPage(_ sender: Any) {
        if currentColor != "" {
            let vc = self.storyboard?.instantiateViewController(withIdentifier: "chapter1_22") as! Chapter1_22
