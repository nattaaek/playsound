...
class Chapter1_39: UIViewController, AVAudioPlayerDelegate, UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    @IBAction func nextPage(_ sender: Any) {
        if currentColor == "red" {
            let vc = self.storyboard?.instantiateViewController(withIdentifier: "chapter1_40")
