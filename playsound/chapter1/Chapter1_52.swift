...
class Chapter1_52: UIViewController, AVAudioPlayerDelegate, AVAudioRecorderDelegate {
    ...
    //var songs : [String]!
    let songsWithMetronome = ["StrongBeat","SubBeat","SubBeat","SubBeat","StrongBeat","SubBeat","SubBeat","SubBeat","C","D","C","SubBeat","C","D","C","SubBeat","C","C","D","D","C","D","C","SubBeat"]
    //let songsWithoutMetronome = ["C","D","C","SubBeat","C","D","C","SubBeat","C","C","D","D","C","D","C","SubBeat"]
    ...
    @IBOutlet weak var bgc7: UIView!
    @IBOutlet weak var bgd5: UIView!
    @IBOutlet weak var bgc8: UIView!
        ...
        if hearItSwitch.isOn {
            ...
            if accompSwitch.isOn && metronomeSwitch.isOn{
                ...
                timer = Timer.scheduledTimer(withTimeInterval: 2.0, repeats: false) { (timer) in
                    if self.tracker.frequency <= 277 && self.tracker.frequency >= 246 && (index == 0 && index == 2 && index == 4 && index == 6 && index == 8 && index == 9 && index == 12 && index == 14 ){
                        self.changeLabelGuide(index: index, isCorrect: true)
                        index += 1
                        self.guideTabChangeController(index: index)
                    } else if self.tracker.frequency <= 311 && self.tracker.frequency >= 276 && (index == 1 && index == 5 && index == 10 && index == 11 && index == 13) {
                        self.changeLabelGuide(index: index, isCorrect: true)
                        index += 1
                        self.guideTabChangeController(index: index)
                    } else if index == 3 || index == 7 || index == 15{
                        self.changeLabelGuide(index: index, isCorrect: true)
                        index += 1
                        self.guideTabChangeController(index: index)
