...
class Chapter1_60: UIViewController,AVAudioPlayerDelegate,UICollectionViewDataSource,UICollectionViewDelegate {
    ...
    @IBOutlet weak var pinkOneButton: UIButton!
    @IBAction func pinkOneController(_ sender: Any) {
        if currentColor == "pink" {            pinkTwoButton.isHidden = false
            pinkOneButton.isHidden = true
        } else {
            wrongChoice()
        }
    }
    ...
    @IBOutlet weak var pinkTwoButton: UIButton!
    @IBAction func pinkTwoController(_ sender: Any) {
        if currentColor == "pink" {            pinkThreeButton.isHidden = false
            pinkTwoButton.isHidden = true
        } else {
            wrongChoice()
        }
    }
    ...
    @IBOutlet weak var pinkThreeButton: UIButton!
    @IBAction func pinkThreeController(_ sender: Any) {
        if currentColor == "pink" {            nextBtn.isHidden = false
            pinkThreeButton.isHidden = true
        } else {
            wrongChoice()
        }
    }
    ...
    @IBAction func nextPage(_ sender: Any) {
        let vc = self.storyboard?.instantiateViewController(withIdentifier: "chapter1_61")
