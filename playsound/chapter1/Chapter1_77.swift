...
class Chapter1_77: UIViewController, AVAudioPlayerDelegate, AVAudioRecorderDelegate {
    ...
    //var songs : [String]!
    let songsWithMetronome = ["StrongBeat","SubBeat","SubBeat","SubBeat","StrongBeat","SubBeat","SubBeat","SubBeat","E","D","C","SubBeat","E","D","C","SubBeat","C","C","D","D","E","D","C","SubBeat"]
    //let songsWithoutMetronome = ["E","D","C","SubBeat","E","D","C","SubBeat","C","C","D","D","E","D","C","SubBeat"]
        ...
        if hearItSwitch.isOn {
            ...
            if accompSwitch.isOn && metronomeSwitch.isOn{
                ...
                timer = Timer.scheduledTimer(withTimeInterval: 2.0, repeats: false) { (timer) in
                    if self.tracker.frequency <= 277 && self.tracker.frequency >= 246 && (index == 2 && index == 6 && index == 8 && index == 9){
                        ...
                        index += 1
                        self.guideTabChangeController(index: index)
                    } else if self.tracker.frequency <= 329 && self.tracker.frequency >= 310 && (index == 0 && index == 4 && index == 12) {
                        self.changeLabelGuide(index: index, isCorrect: true)
                        index += 1
                        self.guideTabChangeController(index: index)
